(() => {
  ...
  const copy = {
    en: {
      certificateTitle: "Participant Record",
      certificateCode: "Commemorative Participant Record",
      certificateBody: "This record commemorates personal participation in the audiovisual screening of\n\"Rap-Ort: Prawda Sumienia\"\n\nan encounter with memory, testimony, silence and the question\nof human responsibility before truth.",
      certificateClosing: "It is not an official institutional document. It is a commemorative trace of presence before testimony.",
      dateField: "Date",
      placeField: "Place",
      ...
      missingName: "Enter the name for the Participant Record.",
      ...
      certificateFormTitle: "Create Participant Record",
      certificateFormCopy: "Enter the name that should appear on the commemorative participant record.",
      ...
      certificateTab: "Participant Record",
    ...
    pl: {
      certificateTitle: "Zapis Uczestnictwa",
      certificateCode: "Pamiątkowy zapis uczestnictwa",
      certificateBody: "Ten zapis upamiętnia osobisty udział w projekcji audiowizualnej\n\"Rap-Ort: Prawda Sumienia\"\n\nspotkaniu z pamięcią, świadectwem, ciszą i pytaniem\no odpowiedzialność człowieka wobec prawdy.",
      certificateClosing: "Nie jest dyplomem ani dokumentem urzędowym. Jest pamiątkowym śladem obecności przy świadectwie.",
      dateField: "Data",
      placeField: "Miejsce",
      ...
      missingName: "Wpisz imię i nazwisko do Zapisu Uczestnictwa.",
      ...
      certificateFormTitle: "Utwórz Zapis Uczestnictwa",
      certificateFormCopy: "Wpisz imię i nazwisko, które ma znaleźć się na pamiątkowym zapisie uczestnictwa.",
      ...
      certificateTab: "Zapis uczestnictwa",
  ...
  function preflightIssues() {
    ...
    if (activeType === "certificate" && config.certificateStamp !== "none" && layoutFragment("certificate", "stamp")?.hidden) {
      issues.push({ level: "warning", text: "Participant record stamp is enabled but hidden." });
    }
  ...
  function exportGuardIssues(payload) {
    ...
    if (payload?.type === "certificate") {
      ...
      if (!printableLayerVisible("certificate", "name")) issues.push("Participant name layer is hidden or too small.");
      return issues;
    }
